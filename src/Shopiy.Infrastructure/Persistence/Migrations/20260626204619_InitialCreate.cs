        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tax = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    shipping = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    ...
                    placed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_Shipping", "\"shipping\" >= 0");
                    table.CheckConstraint("CK_Orders_Subtotal", "\"subtotal\" >= 0");
                    table.CheckConstraint("CK_Orders_Tax", "\"tax\" >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_StockQuantity", "\"stock_quantity\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItems_Total", "\"total\" >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefreshTokens_ExpiresAt", "\"expires_at\" > \"created_at\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "idx_orders_status_pending",
                table: "orders",
                column: "status",
